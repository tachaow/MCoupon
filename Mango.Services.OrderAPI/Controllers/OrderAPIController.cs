    ...
    public class OrderAPIController : ControllerBase
    {
        ...
        public async Task<ResponseDto> ValidateStripeSession([FromBody] int orderheaderId)
        {
            try
            {
                ...
                var paymentIntenSerivce = new PaymentIntentService();
                PaymentIntent paymentIntent = paymentIntenSerivce.Get(session.PaymentIntentId);
                ...
                if (paymentIntent.Status == "succeeded")
                {
                    ...
                    RewardsDto rewardsDto = new()
                    {
                        ...
                        RewardsActivity = Convert.ToInt32(orderHeader.OrderHeaderId),
